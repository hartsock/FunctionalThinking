...
public class Pair<L, R> {
	...
	/**
	 * A non-valid container value NonPair is in the categorical unit of Pair
	 * but still outside the range of valid Pair combinations.
	 * 
	 * @author hartsock
	 */
	public class NonPair extends Pair<L, R> {
		public NonPair(L left, R right) {	super(left, right);	}
